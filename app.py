...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Đuyêt trường tiểu học Minh Quang - ĐT : 0382 6100 69</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Đuyệt trường tiểu học Minh Quang - ĐT: 0382 6100 69</div>", unsafe_allow_html=True)
